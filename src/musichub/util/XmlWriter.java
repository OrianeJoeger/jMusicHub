...
public class XmlWriter {
    ...
    private void saveChansons(Collection<Chanson> chansons, Document document, Element elements) {
    ...
    private void saveLivresAudios(Collection<LivreAudio> livresaudios, Document document, Element elements) {
    ...
    private void saveAlbums(List<Album> albums) throws Exception {
        ...
        for (Album album : albums) {
            ...
            this.saveChansons(album.getChanson(), document, ealbum);
        }
    ...
    private void savePlaylists(List<Playlist> playlists) throws Exception {
        ...
        for (Playlist playlist : playlists) {
            ...
            Collection<Chanson> chansons = new LinkedList<Chanson> ();
            ...
            Collection<LivreAudio> livresaudios = new LinkedList<LivreAudio> ();
            for (IJouable jouable : playlist.getListe()) {
